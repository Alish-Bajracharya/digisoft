...
const Welcome = () => {
  ...
  return (
    <div className="bg-white py-20 px-8 md:px-16 lg:px-32 font-worksans">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-y-12 md:gap-x-24 items-start">        
        {/* Left Title */}
        <motion.div
        ...
        <div className="mt-10 space-y-4">
          {[
            { title: "Event Space", desc: "We provide a collaborative environment to host and organize IT workshops, tech meetups, and community events." },
            { title: "24/7 Access", desc: "Our dedicated support and monitoring ensure round-the-clock service reliability and assistance." },
            { title: "Coffee Bar", desc: "Fueling creativity with an in-house coffee bar where tech minds spark big ideas over great brews." },
            { title: "30+ Happy Employees", desc: "Our team of passionate professionals brings creativity, innovation, and dedication to every project." }
          ].map((item, index) => (
            <div key={index}>
              <button
