...
const ServiceHero = () => {
  return (
    <div className="bg-white py-16 px-4 mt-2 sm:px-6 lg:px-20 xl:px-40 text-center  font-worksans">
      {/* Hero Image */}
      <motion.div
      ...
      >
        <img src={Img} alt="Tablet" className="w-full max-w-5xl h-auto" />
      </motion.div>
      ...
      {/* Grid Section */}
      <motion.div
        className="mt-16 grid grid-cols-1 md:grid-cols-2 gap-12 text-left max-w-5xl mx-auto"
