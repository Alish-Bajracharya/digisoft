  ...
  return (
    <div className="bg-gray-100 py-16 px-4 sm:px-6 lg:px-20 text-center">
      ...
      >
        ...
        <p className="max-w-3xl mx-auto text-gray-600 text-sm sm:text-base leading-relaxed px-4 sm:px-6 lg:px-10">
      ...
      <motion.div
        className="mt-14 grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-8 px-4 sm:px-10 md:px-24 lg:px-48 text-gray-600"
        initial={{ opacity: 0, y: 70 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ delay: 1, duration: 1 }}
      >
        <div className="px-4 sm:px-6 md:px-8">
          <h3 className="font-normal text-lg mb-4">Easy to Use</h3>
          <p className="text-sm text-gray-500">
            Our products are designed with simplicity in mind - no steep learning curves, just smooth and intuitive experiences.
          </p>
        </div>
        <div className="px-4 sm:px-6 md:px-8">
          <h3 className="font-normal text-lg mb-4">Customer-Friendly</h3>
          <p className="text-sm text-gray-500">
            Built to prioritize user satisfaction, our tools adapt to real-world needs and deliver consistent value for your clients.
          </p>
        </div>
        <div className="px-4 sm:px-6 md:px-8">
          <h3 className="font-normal text-lg mb-4">Smart Features</h3>
          <p className="text-sm text-gray-500">
